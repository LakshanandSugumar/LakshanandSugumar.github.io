...
| Solution                                                                                                                                                                                                       | Pros                                                                                                                                            | Cons                                                                      |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| **ICM-42688-P (6-Axis IMU, QFN SMD)**<br>High-performance accelerometer + gyroscope with I²C/SPI<br>**Price: ≈ $4.67/each**<br>[Product Page](https://www.mouser.com/ProductDetail/TDK-InvenSense/ICM-42688-P) | - Supports very high sample rates (>1kHz)<br>- Low noise and high precision<br>- FIFO buffering reduces MCU load<br>- Low power modes available | - QFN package is small and harder to solder<br>- No built-in magnetometer |

### Option 2

| Solution                                                                                                                                                                                                                                                                                              | Pros                                                                                                                      | Cons                                                             |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| **BNO055 (9-DOF with onboard fusion)**<br>Accelerometer + Gyro + Magnetometer with built-in sensor fusion<br>**Price: ≈ $12.00/each**<br>[Product Page](https://www.adafruit.com/product/2472)<br>[Datasheet](https://cdn-learn.adafruit.com/assets/assets/000/125/776/original/bst-bno055-ds000.pdf) | - Built-in sensor fusion simplifies firmware<br>- Outputs orientation directly<br>- I²C interface<br>- Good documentation | - More expensive<br>- Larger footprint<br>- Fusion startup delay |

### Option 3

| Solution                                                                                                                                                            | Pros                                                                                  | Cons                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| **MPU-6050 (6-Axis IMU)**<br>Accelerometer + Gyroscope combo with I²C interface<br>**Price: ≈ $3.50/each**<br>[Product Page](https://www.adafruit.com/product/3886) | - Very common and inexpensive<br>- Strong community support<br>- Simple I²C interface | - Older generation sensor<br>- Higher noise compared to modern parts<br>- Limited long-term availability |
...
| Solution                                                                                                                                                                                                                                                                            | Pros                                                                                                                    | Cons                                                                   |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| **HDC2080 (TI, I²C Humidity/Temp Sensor)**<br>Low-power digital humidity and temperature sensor<br>**Price: ≈ $3.75/each**<br>[Product Page](https://www.mouser.com/new/texas-instruments/ti-hdc2080-digital-sensor/)<br>[Datasheet](https://www.ti.com/lit/ds/symlink/hdc2080.pdf) | - Very low power consumption<br>- Good accuracy and stability<br>- I²C interface<br>- Strong manufacturer documentation | - Requires proper PCB layout for accuracy<br>- Needs pull-up resistors |

### Option 2

| Solution                                                                                                                                                                         | Pros                                                  | Cons                                                                              |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | --------------------------------------------------------------------------------- |
| **AHT21 (I²C Humidity/Temp Sensor)**<br>Compact humidity and temperature sensor<br>**Price: ≈ $2.20/each**<br>[Product Page](www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web) | - Low cost<br>- I²C compatible<br>- Good availability | - Slightly less accurate than TI parts<br>- Requires careful voltage verification |

### Option 3

| Solution                                                                                                                                                            | Pros                                        | Cons                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- | --------------------------------------------------------------------------------------- |
| **DHT11 (Digital Temp/Humidity)**<br>Single-wire temperature and humidity sensor<br>**Price: ≈ $1.50/each**<br>[Product Page](https://www.adafruit.com/product/386) | - Very inexpensive<br>- Simple to prototype | - Low accuracy<br>- Timing-sensitive protocol<br>- Not ideal for engineering validation |
...
| Solution                                                                                                                                                                                           | Pros                                                                           | Cons                   |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ | ---------------------- |
| **6×6mm SMD Tactile Switch**<br>Surface-mount momentary pushbutton<br>**Price: ≈ $0.30/each**<br>[Product Page](https://www.digikey.com/en/product-highlight/s/schurter/6-mm-x-6-mm-tact-switches) | - Easy to solder<br>- Clear tactile feedback<br>- Durable for repeated lab use | - Larger PCB footprint |

**Status Indicators (0805 SMD LEDs):** **≈ $0.10/each**
...
| Solution                                                                                                                                                                                                                                                                       | Pros                                                                                                                | Cons                                         |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| **AP63203WU-7 (3.3V Buck Converter)**<br>3A SMD switching regulator<br>**Price: ≈ $1.50/each**<br>[Product Page](https://www.google.com/search?q=AP63203WU-7+3.3V+Buck+Converter)<br>[Datasheet](https://www.diodes.com/assets/Datasheets/AP63200-AP63201-AP63203-AP63205.pdf) | - High current capability<br>- Surface mount compliant<br>- Good efficiency<br>- Already used in team documentation | - Requires external inductor and layout care |
...
| **IMU (Motion Sensor)**   | ICM-42688-P                           | TDK InvenSense       | 6-axis accel + gyro, FIFO buffer, I²C/SPI, >50Hz     | ≈ $4.67   | DigiKey    |
...
**Estimated Total Core Component Cost: ≈ $20–$22 per board**  
